...
mus = {"water": 0.89e-3, "water80": 1.57e-3, "water60": 3.99e-3, "water40": 6.06e-3, "ethaline": 45.23e-3}
rhos = {"water": 1e3, "water80": 1.0239e3, "water60": 1.05329e3, "water40": 1.07819e3, "ethaline": 1.11614e3}
Ds = {"water": 7.85e-10, "water80": 5.64e-10, "water60": 3.33e-10, "water40": 1.53e-10, "ethaline": 0.22e-10}
viscs = {
    "water": 0.89e-6,
    "water80": mus["water80"] / rhos["water80"],
    "water60": mus["water60"] / rhos["water60"],
    "water40": mus["water40"] / rhos["water40"],
    "ethaline": mus["ethaline"] / rhos["ethaline"]
}
prefixs = {
    "water": "_45degree",
    "water40": "_ethaline",
...
def main(fluid: str, refine: int, is_negative: bool):
    ...
    for Re in Res:
        ...
        os.system(
            f"python demo_2d_LBM_JRL_fluid{prefix}.py --Re {Re} --vel_obs_real {vel_obs} {fluid_prefix} --gravity_strength_real {-9.8} --refine {refine}"
        )
        os.system(
            f"python demo_2d_LBM_JRL_C{prefix}.py --Re {Re} --Pe {Pe} --vel_obs_real {vel_obs} {fluid_prefix} --gravity_strength_real {-9.8} --{negpos_prefix} --refine {refine}"
        )
